...
const { AZURE_STORAGE_ACCOUNT_NAME, AZURE_STORAGE_ACCESS_KEY } = process.env;
const blobContainerName = AZURE_STORAGE_CONTAINER_NAME;
...
const captureCallback = (error, location) => {
  ...
  blobService.createBlockBlobFromLocalFile(blobContainerName, `${filename}.jpg`, location, blobUploadCallback);
};
